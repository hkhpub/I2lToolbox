...
public class Regression_Transform {

	public static String INPUT_FILE = "D:/data.i2l/kospi.csv";
	public static String SPACE = " ";
	public static String COMMA = ", ";
	public static String OUTPUT_FILE = "D:/github.i2l/Dataset/kospi/kospi_rdp5";
...
//		List<String> directionList = transformer.getRDP5Direction(rdpPost5List);
		...
		try {
			...
			if (writeForm == CSV_FORM) {
				// write csv header
				bw.write("ema100, rdp5, rdp10, rdp15, rdp20, rdp5post");
				bw.write("\n");
			}
			for (int i=0; i<kospiList.size(); i++) {
				...
				if (writeForm == CSV_FORM) {
					...
					bw.write(rdpPost5List.get(i).rdp5_post+"");
					bw.write("\n");
					
				} else if (writeForm == LIBSVM_FORM) {
					bw.write(rdpPost5List.get(i).rdp5_post+SPACE);
